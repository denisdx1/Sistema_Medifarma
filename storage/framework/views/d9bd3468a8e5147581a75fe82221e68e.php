...
window.atc4ListRoute = '<?php echo e(route("market-management.atc4-list")); ?>';
window.atc4CountRoute = '<?php echo e(route("market-management.atc4-count")); ?>';
window.productosIndexRoute = '<?php echo e(route("productos.index")); ?>';
window.productosNuevosSinAsignarRoute = '<?php echo e(route("market-management.productos-nuevos-sin-asignar")); ?>';
window.createMarketRoute = '<?php echo e(route("productos.create-market")); ?>';
window.currentUser = '<?php echo e(auth()->user()->usuario); ?>';
window.isGerenteProducto = <?php echo e(auth()->user()->idRol == 2 ? 'true' : 'false'); ?>;
</script>
<script src="<?php echo e(asset('js/market-management.js')); ?>"></script>
<script src="<?php echo e(asset('js/market-management-main.js')); ?>"></script>
