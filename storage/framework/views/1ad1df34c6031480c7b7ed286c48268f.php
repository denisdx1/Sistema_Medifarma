<aside id="sidebar" class="w-56 bg-white text-gray-800 flex flex-col transition-all duration-300 ease-in-out border-r border-gray-200">
    ...
    <nav class="flex-1 mt-6">
        ...
        <ul>
            <!-- Market Management -->
             <li>
                <a href="<?php echo e(route('market-management.index')); ?>" class="flex items-center px-4 py-2.5 <?php echo e(request()->routeIs('market-management.*') ? 'text-red-700 bg-red-50' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'); ?> rounded-lg mx-2 transition-all duration-200">
        ...
        <div class="mt-6">
            ...
            <ul>
                <!-- User Management -->
                <li>
                    <a href="<?php echo e(route('usuarios.index')); ?>" class="flex items-center px-4 py-2.5 <?php echo e(request()->routeIs('usuarios.*') ? 'text-blue-700 bg-blue-50' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'); ?> rounded-lg mx-2 transition-all duration-200">
                        <i class="fas fa-users w-6 text-center <?php echo e(request()->routeIs('usuarios.*') ? 'text-blue-600' : 'text-gray-400'); ?>"></i>
    ...
    <div class="p-4 border-t border-gray-200">
        <div class="flex items-center">
            ...
            <div class="sidebar-text ml-3">
                <p class="text-sm font-semibold text-gray-800"><?php echo e(Auth::user()->usuario); ?></p>
