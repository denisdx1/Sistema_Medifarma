            ...
            .then(data => {
                if (data.habilitado) {
                    ...
                    if (confirm('¡El sistema está disponible ahora! ¿Desea acceder?')) {
                        window.location.href = '<?php echo e(route("market-management.index")); ?>';
                    }
                }
            })
            .catch(error => {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\druizp\Desktop\Sistema_Medifarma\resources\views/auth/access-denied.blade.php ENDPATH**/ ?>