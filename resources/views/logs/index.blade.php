...
<div class="container mx-auto px-4 py-6">
        ...
        <div class="bg-white p-4 rounded-lg shadow border-l-4 border-yellow-500">
            <div class="flex items-center">
                <div class="flex-1">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $acciones->count() }}</p>
                </div>
        ...
        <div class="bg-white p-4 rounded-lg shadow border-l-4 border-purple-500">
            <div class="flex items-center">
                <div class="flex-1">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $page }} de {{ $totalPages }}</p>
                </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border p-6 mb-6">
        <form method="GET" action="{{ route('logs.index') }}" id="filters-form">
                ...
                <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                    <div>
                        <p class="text-sm text-gray-700">
                            ...
                            a 
                            <span class="font-medium">{{ min($page * $perPage, $totalRecords) }}</span>
                            de 
