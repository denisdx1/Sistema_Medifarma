    ...
    <div class="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div id="mobile-menu" class="md:hidden hidden border-t border-gray-200 bg-white shadow-lg">
            <div class="px-2 pt-2 pb-3 space-y-1">
                <!-- Market Management -->
                <a href="{{ route('market-management.index') }}" 
                   class="flex items-center px-3 py-3 text-base font-medium rounded-lg transition-colors duration-200 {{ request()->routeIs('market-management.*') ? 'text-red-700 bg-red-50 border-l-4 border-red-500' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }}">
                    <i class="fas fa-clipboard-list mr-3 text-lg {{ request()->routeIs('market-management.*') ? 'text-red-600' : 'text-gray-400' }}"></i>
                    <div>
                ...
                <!-- Productos Database -->
                <a href="{{ route('productos.index') }}" 
                   class="flex items-center px-3 py-3 text-base font-medium rounded-lg transition-colors duration-200 {{ request()->routeIs('productos.*') ? 'text-green-700 bg-green-50 border-l-4 border-green-500' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }}">
                    <i class="fas fa-database mr-3 text-lg {{ request()->routeIs('productos.*') ? 'text-green-600' : 'text-gray-400' }}"></i>
                    <div>
                ...
                @if(Auth::user()->isAdmin())
                    <div class="border-t border-gray-200 pt-2 mt-2">
                        ...
                        <a href="{{ route('usuarios.index') }}" 
                           class="flex items-center px-3 py-3 text-base font-medium rounded-lg transition-colors duration-200 {{ request()->routeIs('usuarios.*') ? 'text-blue-700 bg-blue-50 border-l-4 border-blue-500' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }}">
                            <i class="fas fa-users mr-3 text-lg {{ request()->routeIs('usuarios.*') ? 'text-blue-600' : 'text-gray-400' }}"></i>
                            <div>
                        ...
                        <a href="{{ route('logs.index') }}" 
                           class="flex items-center px-3 py-3 text-base font-medium rounded-lg transition-colors duration-200 {{ request()->routeIs('logs.*') ? 'text-purple-700 bg-purple-50 border-l-4 border-purple-500' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }}">
                            <i class="fas fa-clipboard-list mr-3 text-lg {{ request()->routeIs('logs.*') ? 'text-purple-600' : 'text-gray-400' }}"></i>
                            <div>
