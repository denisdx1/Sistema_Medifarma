                ...
                <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; padding: 20px; margin: 20px 0; border-radius: 4px;">
                    @if($actionType === 'create')
                        ...
                        <div style="padding: 12px 0; border-bottom: 1px solid #d1d5db;">
                            ...
                            <span style="color: #111827; font-weight: 600;">{{ $actionData['market_name'] }}</span>
                        </div>
                    ...
                    @elseif($actionType === 'update')
                        ...
                        <div style="padding: 12px 0; border-bottom: 1px solid #d1d5db;">
                            ...
                            <span style="color: #dc2626;">{{ $actionData['old_name'] }}</span>
                        </div>
                        <div style="padding: 12px 0; border-bottom: 1px solid #d1d5db;">
                            <span style="font-weight: bold; color: #4b5563; display: inline-block; width: 140px;">Nombre nuevo:</span>
                            <span style="color: #059669; font-weight: 600;">{{ $actionData['new_name'] }}</span>
                        </div>
                        @endif
                    ...
                    @elseif($actionType === 'assign_product')
                        ...
                        <div style="padding: 12px 0; border-bottom: 1px solid #d1d5db;">
                            ...
                            <span style="color: #059669; font-weight: 600;">{{ $actionData['market_name'] }}</span>
                        </div>
                        <div style="padding: 12px 0; border-bottom: 1px solid #d1d5db;">
                            <span style="font-weight: bold; color: #4b5563; display: inline-block; width: 140px;">Productos asignados:</span>
                            <span style="color: #059669; font-weight: 600;">{{ $actionData['assigned_count'] }} productos</span>
                        </div>
                            ...
                            <div style="background-color: #f9fafb; padding: 12px; border-radius: 4px; border-left: 4px solid #7c3aed;">
                                @foreach($actionData['assigned_products'] as $index => $product)
                                    <div style="margin-bottom: 8px; padding: 8px; background-color: #ffffff; border-radius: 4px; border: 1px solid #e5e7eb;">
                                        @if(is_array($product))
                                            <div style="color: #111827; font-weight: 600; margin-bottom: 4px;">{{ $product['name'] ?? 'Nombre no disponible' }}</div>
                                            <div style="color: #6b7280; font-family: monospace; font-size: 13px;">Código: {{ $product['code'] }}</div>
                                        @else
                                            <span style="color: #111827; font-family: monospace; font-size: 14px;">{{ $product }}</span>
                                        @endif
                                    </div>
                                @endforeach
                            </div>
                    ...
                    @elseif($actionType === 'move_product')
                        ...
                        <div style="padding: 12px 0; border-bottom: 1px solid #d1d5db;">
                            ...
                            <span style="color: #111827; font-weight: 600;">{{ $actionData['product_name'] ?? $actionData['product_code'] }}</span>
                        </div>
                        ...
                        <div style="padding: 12px 0; border-bottom: 1px solid #d1d5db;">
                            ...
                            <span style="color: #dc2626;">{{ $actionData['from_market'] }}</span>
                        </div>
                        @endif
                        <div style="padding: 12px 0; border-bottom: 1px solid #d1d5db;">
                            <span style="font-weight: bold; color: #4b5563; display: inline-block; width: 140px;">Mercado nuevo:</span>
                            <span style="color: #059669; font-weight: 600;">{{ $actionData['to_market'] }}</span>
                        </div>
                    ...
                    @elseif($actionType === 'remove_product')
                        ...
                        <div style="padding: 12px 0; border-bottom: 1px solid #d1d5db;">
                            ...
                            <span style="color: #dc2626;">{{ $actionData['market_name'] }}</span>
                        </div>
                    ...
                    @elseif($actionType === 'test')
                        ...
                        <div style="padding: 12px 0; border-bottom: 1px solid #d1d5db;">
                            ...
                            <span style="color: #111827; font-weight: 600;">{{ $actionData['message'] }}</span>
                        </div>
                        <div style="padding: 12px 0; border-bottom: 1px solid #d1d5db;">
                            <span style="font-weight: bold; color: #4b5563; display: inline-block; width: 140px;">Fecha de prueba:</span>
                            <span style="color: #6b7280;">{{ $actionData['timestamp'] }}</span>
                        </div>
                    @endif
                    ...
                    <div style="padding: 12px 0; border-bottom: 1px solid #d1d5db;">
                        ...
                        <span style="color: #111827;">{{ $performedBy }}</span>
                    </div>
                    ...
                    <div style="padding: 12px 0;">
                        ...
                        <span style="color: #111827;">{{ date('d/m/Y H:i:s', strtotime($performedAt)) }}</span>
                    </div>
                </div>
